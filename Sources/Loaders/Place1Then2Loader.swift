...
@available(*, unavailable, renamed: "P1T2Loader")
public protocol P1T2L: class {}
...
@available(*, unavailable, renamed: "load(p1t2Loader:intent:)")
public func load<T: P1T2Loader>(loader: T, intent: LoaderIntent) -> SectionObservable {
  return .just(nil)
}
