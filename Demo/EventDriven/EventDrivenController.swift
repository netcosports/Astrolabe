...
class EventDrivenController: UIViewController {
  ...
  let viewModel: EventDrivenViewModel

  init() {
    let input = EventDrivenViewModel.Input(
    ...
    viewModel = EventDrivenViewModel(input: input)
